...
def ds_gen():
    dirname = '/app/WorldModels/results/{}/{}/record'.format(args.exp_name, args.env_name)
...
if __name__ == "__main__": 
    model_save_path = "results/{}/{}/tf_ganvae".format(args.exp_name, args.env_name)
